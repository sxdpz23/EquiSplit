...
class _QRScannerState extends State<QRScanner> {
  ...
  Widget build(BuildContext context) {
    ...
    final double focusSide = totalSize.width * 0.7;
    ...
    return Stack(
      children: <Widget>[
        ...
        _darkblock(
          ...
          left: 0,
          right: 0,
          height: (totalSize.height - focusSide) / 3,
        ),
        _darkblock(
          top: 0,
          left: 0,
          bottom: 0,
          width: (totalSize.width - focusSide) / 2,
        ),
        _darkblock(
          top: 0,
          right: 0,
        ...
        _darkblock(
          ...
          right: 0,
          bottom: 0,
          height: (totalSize.height - focusSide) * 2 / 3,
        ),
        Positioned(
          top: (totalSize.height - focusSide) / 3 - 15,
          left: (totalSize.width - focusSide) / 2 - 15,
          child: Container(
            height: focusSide + 30,
            width: focusSide + 30,
            decoration: BoxDecoration(
        ...
        Positioned(
          top: ((totalSize.height - focusSide) / 3) + focusSide + 40.0,
          left: (totalSize.width - focusSide) / 2 + 15,
          right: (totalSize.width - focusSide) / 2 + 15,
          bottom: (totalSize.height - focusSide) / 4,
